        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card mb-4 box-shadow card-home">
                    <img class="card-img-top" alt="recommendations image" style="height: auto; width: 100%; display: block;" src="{{asset('images/toptracks.png')}}">
                    <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6">
                <div class="card mb-4 box-shadow card-home">
                    <img class="card-img-top" alt="Thumbnail [100%x225]" style="height: auto; width: 100%; display: block;" src="{{asset('images/topartists.png')}}">
                    <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6">
                <div class="card mb-4 box-shadow card-home">
                    <img class="card-img-top" alt="Thumbnail [100%x225]" style="height: auto; width: 100%; display: block;" src="{{asset('images/recommendations.png')}}" >
                    <div class="card-body">
