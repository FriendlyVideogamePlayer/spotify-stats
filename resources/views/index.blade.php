        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card mb-4 box-shadow card-home">
                    ...
                    <div class="card-body">
                    <p class="card-text lead text-card">View your top 50 tracks on Spotify from the last 4 weeks, 6 months or all time!</p>
                ...
                <div class="card mb-4 box-shadow card-home">
                    ...
                    <div class="card-body">
                    <p class="card-text lead text-card">View your top 50 artists on Spotify from the last 4 weeks, 6 months or all time!</p>
                    <div class="d-flex justify-content-between align-items-center">
                    </div>
                    </div>
                </div>
