...
<div class="homeFooter" role="main">
    <div class="container justify-content-center">
        <div class="index pt-3">
            ...
            <h2 class="text-card pb-1 pt-1" role="heading" aria-level="1">Information collection and usage</h2>
            ...
            <h2 class="text-card pb-1 pt-1" role="heading" aria-level="1">Cookies</h2>
